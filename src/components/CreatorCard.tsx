  ...
  return (
    <div className="rounded-xl overflow-hidden bg-aura-charcoal border border-white/10 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-aura-purple/20">
      ...
      <div className="h-24 bg-gradient-to-br from-aura-blue to-aura-purple relative">
        ...
        {/* Profile image positioned on the header */}
        <Avatar className="absolute -bottom-6 left-5 h-16 w-16 border-2 border-aura-charcoal ring-2 ring-white/10">
        ...
        {/* Subscribe button moved to align with avatar */}
      ...
      <div className="p-4 pt-8 relative">
        {/* Content section with improved padding and no button */}
        <div className="mb-2">
          <div className="flex items-center gap-1.5 mb-0.5">
            <h3 className="font-semibold text-base truncate max-w-[200px]">{name}</h3>
            {isVerified && (
        ...
        <p className="text-sm text-gray-300 line-clamp-2 mb-3 mt-2">{description}</p>
