...
const Queue = () => {
  ...
  return (
    <MainLayout title="QUEUE" backButton={true}>
      <div className="p-6">
        ...
        <div className="mb-6 flex gap-2">
          ...
          <Button 
            variant={filter === "scheduled" ? "gradient" : "outline"} 
            size="sm" 
        ...
        <div className="space-y-4">
          {filteredItems.map(item => (
            <div 
              key={item.id} 
              className="bg-aura-charcoal border border-white/10 rounded-lg p-4 flex items-center justify-between hover:border-aura-purple transition-all"
            >
